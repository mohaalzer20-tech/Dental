...
export default async function SettingsPage() {
  ...
  const [{ data: practice }, { data: accounts }] = await Promise.all([
    supabase
      .from("practices")
      .select(
        "id, clinic_name, doctor_name, address, phone, email, tax_number, license_number, currency, default_cash_account_id, default_bank_account_id, default_revenue_account_id",
      )
      .single(),
